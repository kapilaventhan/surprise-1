...
<div className="w-28 h-28 rounded-3xl bg-gradient-to-tr from-[#FF6FAE] via-pink-500 to-purple-600 flex items-center justify-center text-white shadow-2xl">

<Gift className="w-14 h-14 animate-bounce"/>
...
A Special Message Just For You. Tap to unlock your personal video gift!
</p>
...
<div
ref={containerRef}
className="relative rounded-2xl overflow-hidden aspect-video bg-slate-950 flex items-center justify-center"
>
